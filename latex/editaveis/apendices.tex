...
Gyroscope X Temperature Measurement   & 8  & $^{\circ}$C                \\
Gyroscope Y Temperature Measurement   & 8  & $^{\circ}$C                \\
Gyroscope Z Temperature Measurement   & 8  & $^{\circ}$C                \\
Magnetometer Temperature Measurement  & 8  & $^{\circ}$C                \\
MSP Temperature Measurement           & 8  & $^{\circ}$C                \\
Magnetotorquer X Current Measurement  & 8  & mA                         \\
Magnetotorquer Y Current Measurement  & 8  & mA                         \\
Magnetotorquer Z Current Measurement  & 8  & mA                         \\
Magnetotorquer X Current Command      & 8  & mA                         \\
Magnetotorquer Y Current Command      & 8  & mA                         \\
Magnetotorquer Z Current Command      & 8  & mA                         \\
Spare 2 bits (not used)                                                                   & 2                      &                            \\
MSP ADCS Mode                                                                             & 1                      &                            \\
...
%Magnetometer Z On/Off Flag& 1 &                        \\
%Bdot Maximum Output Current                                                               & 8                      & mA                         \\
%MSP Measurement Counter                                                                   & 8                      &                            \\
%Magnetometer ADC GND Voltage  Measurement      & 8                      & mV                         \\
%Magnetometer ADC Vcc Voltage  Measurement      & 8                      & mV                         \\
%Gyroscope ADC Gnd Voltage  Measurement         & 8                      & mV                         \\
%Gyroscope ADC Vcc Voltage  Measurement         & 8                      & mV                         \\
%MSP (Vcc-Vss)/2 Voltage  Measurement           & 8                      & mV                         \\
%MSP Vref+ Voltage Measurement                                                             & 8                      & mV                         \\
MSP Vref- Voltage Measurement                                                             & 8                      & mV           
\\ \hline
\multicolumn{1}{|l|}{TOTAL}      & 640   & \multicolumn{1}{c|}{bits}  \\
\multicolumn{1}{|l|}{}           & 80   & \multicolumn{1}{c|}{bytes} \\ \hline
